...
class FrontendForm extends SpoonForm
{
	 ...
	 * @param string[optional] $action The action (URL) whereto the form will be submitted, if not provided it will be auto generated.
	...
	public function addDate($name, $value = null, $type = null, $date = null, $date2 = null, $class = null, $classError = null)
	{
		...
		// validate
		if($type == 'from' && ($date == 0 || $date == null)) throw new FrontendException('A date field with type "from" should have a valid date-parameter.');
		if($type == 'till' && ($date == 0 || $date == null)) throw new FrontendException('A date field with type "till" should have a valid date-parameter.');
		if($type == 'range' && ($date == 0 || $date2 == 0 || $date == null || $date2 == null)) throw new FrontendException('A date field with type "range" should have 2 valid date-parameters.');
	 ...
	 */
	public function addMarkdownEditor($name, $value = null, $class = null, $classError = null, $HTML = false)
	{
		$name = (string) $name;
		$value = ($value !== null) ? (string) $value : null;
		$class = 'inputMarkdownEditor ' . (string) $class;
		$classError = 'inputMarkdownEditorError ' . (string) $classError;
		$HTML = (bool) $HTML;
...
class FrontendFormDate extends SpoonFormDate
{
	...
	public function isValid($error = null)
	{
		...
		// validate date field that have a till-date set
		...
		// validate date field that have a from and till-date set
